...
export default function RecyclingDash() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.wasteId || !formData.recycledProduct || !formData.quantity || !formData.method) {
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="Amendement organique">Amendement organique</option>
                  <option value="Substrat de culture">Substrat de culture</option>
                </select>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <option value="Compostage traditionnel">Compostage traditionnel</option>
                  <option value="Compostage accéléré">Compostage accéléré</option>
                  <option value="Méthanisation">Méthanisation</option>
                  <option value="Pyrolyse">Pyrolyse</option>
                  <option value="Broyage et valorisation">Broyage et valorisation</option>
                  <option value="Transformation biologique">Transformation biologique</option>
                </select>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            {loading && recyclings.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="mt-4 text-gray-600">Chargement des recyclages...</p>
              </div>
            ) : recyclings.length === 0 ? (
                ...
                {recyclings.map((recycling) => (
                  ...
                  >
                    ...
                    <div className="text-sm text-gray-600 space-y-1">
                      <p><strong>ID:</strong> {recycling.id}</p>
                      <p><strong>Déchet source:</strong> {recycling.wasteId}</p>
                      <p><strong>Quantité:</strong> {recycling.quantity} kg</p>
                      <p><strong>Méthode:</strong> {recycling.method}</p>
                      <p><strong>Date:</strong> {new Date(recycling.recyclingDate).toLocaleDateString('fr-FR')}</p>
                    </div>
                  </div>
                ))}
              </div>
